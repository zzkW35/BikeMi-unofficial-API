...
Welcome to `BikeMi-unofficial-API` contributor's guide.
...
If you experience bugs or general issues with `BikeMi-unofficial-API`, please have a look
...
You can help improve `BikeMi-unofficial-API` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`BikeMi-unofficial-API` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `BikeMi-unofficial-API`'s files. While this mechanism can
...
```
conda create -n BikeMi-unofficial-API python=3 six virtualenv pytest pytest-cov
conda activate BikeMi-unofficial-API
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/BikeMi-unofficial-API.git
   cd BikeMi-unofficial-API
   ```
...
5. Install [pre-commit]:
   ...
   `BikeMi-unofficial-API` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/BikeMi-unofficial-API
[issue tracker]: https://github.com/<USERNAME>/BikeMi-unofficial-API/issues
